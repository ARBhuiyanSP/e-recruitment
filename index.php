...
<html>
    <head>
        ...
        <title>Recruitment Requisition Request | Log in</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 login-sec">
                        <h2 class="text-center">Recruitment Requisition Request Login</h2>
                    ...
                    <div class="col-md-8 login-background">
                        <h2 style="margin: 25%; color: white;">Welcome to Recruitment Requisition Request Application</h2>
                    </div>
                </div>
            </div>
        </section>
